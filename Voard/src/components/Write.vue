    ...
    <v-main>
      <v-container>
        <v-sheet max-width="800" class="mx-auto">
          <v-text-field label="제목입력" variant="outlined" v-model="article.title"></v-text-field>
          <v-textarea label="내용입력" variant="outlined" rows="12" v-model="article.content"></v-textarea>
        ...
        <v-dialog v-model="dialog" width="auto">
          <v-card>
            ...
            <v-card-text>작성한 글이 업로드 되었습니다.</v-card-text>
            <v-card-actions>
              <v-spacer />
