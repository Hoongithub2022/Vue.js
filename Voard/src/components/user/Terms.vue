    ...
    <v-main>
      <v-container>
        <v-sheet max-width="800" class="mx-auto mt-16">
          <v-textarea label="이용약관" variant="outlined" rows="10" hide-details="true"></v-textarea>
          <v-checkbox class="d-flex justify-end" label="동의합니다."></v-checkbox>
          <v-textarea label="개인정보 취급방침" rows="10" variant="outlined" hide-details="true"></v-textarea>
          <v-checkbox class="d-flex justify-end" label="동의합니다."></v-checkbox>
        </v-sheet>
