<template>
  ...
  <router-link v-bind:to="{ path: '/component1', query: { name: '홍길동', age: 21, addr: '부산' } }">Component1</router-link> /
  <router-link v-bind:to="{ name: 'Component2', params: { name: '홍길동', age: 21, addr: '부산' } }">Component2</router-link> /
